package com.bwie.weidushopping.homepage.fragmentzhangdan.fragment.fragmentdaishouhuo;
...
import com.bwie.weidushopping.homepage.fragmentzhangdan.fragment.fragmentdaishouhuo.adapter.DaiShouHuoDingDanAdapter;
import com.bwie.weidushopping.homepage.fragmentzhangdan.fragment.fragmentdaishouhuo.presenter.Presenter;
 ...
 * date:2018/12/16
 * author:张自力(DELL)
 * function:  我的订单界面Fragment  的待收货Fragment
 */

public class FragmentDDFDaiShouHuoF extends Fragment implements IView {

    private XRecyclerView xlvQuanbudingdanWdddf;
    private Presenter mPresenter;
    private List<QuanBuDingDanBean.OrderListBean> mListBeans;
    private DaiShouHuoDingDanAdapter mDaiShouHuoDingDanAdapter;
    ...
    private XRecyclerView xlvDaishouhuodingdanWdddf;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_zdf_dshhf, null);
        //初始化控件
        initView(view);
        //SP设置
        initSP(view);
    ...
    private void initListAndAdapter(View view) {
        ...
        mDaiShouHuoDingDanAdapter = new DaiShouHuoDingDanAdapter(getActivity(), mListBeans);
        xlvQuanbudingdanWdddf.setAdapter(mDaiShouHuoDingDanAdapter);
    }
    ...
    private void initView(View view) {
        //展示订单的xlv
        xlvQuanbudingdanWdddf = (XRecyclerView) view.findViewById(R.id.xlv_daishouhuodingdan_wdddf);
        //布局管理器设置
    ...
    public void getQuanBuDingDanDataWDZDF(List<QuanBuDingDanBean.OrderListBean> listBeans) {
        ...
        if (listBeans != null) {
            ...
            mDaiShouHuoDingDanAdapter.notifyDataSetChanged();
        }
