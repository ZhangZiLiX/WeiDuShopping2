...
public class Presenter {
    ...
    public void getQuanZiDataP(int page){
        ...
        String url = "http://mobile.bwstudent.com/small/circle/v1/findCircleList?count=5&page=";
        url = url+page;
        //定义一个泛型
    ...
    public void getQuanZiDianZanDataP(int circleid,String phone,String pwd,int userId,String sessionId){
        ...
        //http://mobile.bwstudent.com
        String url = "http://mobile.bwstudent.com/small/circle/verify/v1/addCircleGreat?circleId=";
        url = url+circleid;
        //定义一个泛型
    ...
    public void getQuanZiFaBuDataP(String commodityId,String  content, int userId, String sessionId){
        ...
        String url = "http://mobile.bwstudent.com/small/circle/verify/v1/releaseCircle";
                //url = url+circleid;
                //定义一个泛型
