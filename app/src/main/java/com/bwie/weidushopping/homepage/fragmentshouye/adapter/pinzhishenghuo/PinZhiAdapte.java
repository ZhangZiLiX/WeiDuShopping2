package com.bwie.weidushopping.homepage.fragmentshouye.adapter.pinzhishenghuo;
 ...
 * date:2018/12/7
 * author:张自力(DELL)
 * function:  首页Fragment  品质生活的Adapter
 */

public class PinZhiAdapte extends XRecyclerView.Adapter<PinZhiAdapte.ViewHolder>{

    //定义一个接口
    public interface PZSHOnClickListener{
        void onChanger(int id);
    }
    private PZSHOnClickListener mlistener;
    public void setPZSHOnClickListener (PZSHOnClickListener listener){
        this.mlistener = listener;
    }

    private Context mContext;
    private List<ShopBean.ResultBean.PzshBean.CommodityListBeanX> mList;
    public PinZhiAdapte(Context context, List<ShopBean.ResultBean.PzshBean.CommodityListBeanX> list) {
        mContext = context;
        mList = list;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.pinzhishenghuo_adapter_syf,parent,false);
...
/*            //===========
            ...
            //===========*/
            mImgRXXPSYF = itemView.findViewById(R.id.img_pzsh_syf);//商品图图
            mTxtNameRXXPSYF = itemView.findViewById(R.id.txtname_pzsh_syf);//名
            mTxtPriceRXXPSYF = itemView.findViewById(R.id.txtprice_pzsh_syf);//价格
            mTxtNumberRXXPSYF = itemView.findViewById(R.id.txtnumber_pzsh_syf); //已售件数
        }
    }
