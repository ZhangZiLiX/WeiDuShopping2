package com.bwie.weidushopping.homepage.fragmentzhangdan.fragment.fragmentdaifukuan;
 ...
 * date:2018/12/16
 * author:张自力(DELL)
 * function:  我的订单界面Fragment  的待付款Fragment
 */

public class FragmentDDFDaiFuKuanF extends Fragment implements IView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.fragment_zdf_dfkf, null);
        //1 初始化控件
        initView(view);
        //SP设置
        initSP(view);
    ...
    private void initView(View view) {
        ...
        txtZanwudingdan = (TextView) view.findViewById(R.id.txtZanwudingdan);
        if(iswudingdan){
