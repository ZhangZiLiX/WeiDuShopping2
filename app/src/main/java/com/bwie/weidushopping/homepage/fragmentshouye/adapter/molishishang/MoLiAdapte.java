package com.bwie.weidushopping.homepage.fragmentshouye.adapter.molishishang;
...
public class MoLiAdapte extends XRecyclerView.Adapter<MoLiAdapte.ViewHolder>{
    ...
    private List<ShopBean.ResultBean.MlssBean.CommodityListBean> mList;
    public MoLiAdapte(Context context, List<ShopBean.ResultBean.MlssBean.CommodityListBean> list) {
        mContext = context;
        mList = list;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.molishishang_adapter_syf,parent,false);
...
/*            //===========
            ...
            //===========*/
            mImgRXXPSYF = itemView.findViewById(R.id.img_mlss_syf);//商品图图
            mTxtNameRXXPSYF = itemView.findViewById(R.id.txtname_mlss_syf);//产品介绍
            mTxtPriceRXXPSYF = itemView.findViewById(R.id.txtprice_mlss_syf);//价格
            mTxtNumberRXXPSYF = itemView.findViewById(R.id.txtnumber_mlss_syf); //已售件数
        }
    }
